...
module Mprover  : Map_intf.PMap with type key = prover
module Sprover  : Map_intf.Set with type M.key = Mprover.key
         and type 'a M.data = 'a
         and type 'a M.t = 'a Mprover.t
...
module Meditor : Map_intf.PMap with type key = string
